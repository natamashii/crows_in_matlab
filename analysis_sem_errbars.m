...
% DONE to all plots with performance: make it in percentage & add [% correct] in ylabel
...
% DONE avg trial rate per session for everyone
...
% DONE difference plot birds: divide into exp 1 times & exp1 vs exp2
% mark p value in standard/control & jello/uri plot
% DONE imporve single plot
...
% DONE something is wrong with calling data for plot_uebersicht_detail
% do expectation plots
    ...
    for who_idx = 1:length(who_analysis) - 1
        ...
        for exp_idx = 1:length(curr_experiments)
            ...
            fig = plot_s_c(numerosities, ind_data_s, ind_data_c, ...
                ...
                false, axis_colour, subfig_title{what_idx, plot_idx});
            
            fig_name = [focus_type{focus_idx} '_StandCont_' ...
                calc_type{calc_idx} '_' err_type{err_idx} '_' ...
                what_analysis{what_idx} '_' aim_name '.' format];
...
if to_split_ju
    ...
    for exp_idx = 1:length(curr_experiments)
        ...
        fig = ...
            ...
            linewidth, capsize, linestyle, {'Crow 1', 'Crow 2'}, ...
            false, axis_colour, subfig_title{what_idx, plot_idx});
        ...
        for exp_idx = 1:length(curr_experiments)
            ...
            if who_idx == 4
                ...
                fig = plot_uebersicht({ind_data_j, ind_data_u}, ...
                    ...
                    0.3, 4, {lin_reg_jello, lin_reg_uri}, true, false, ...
                    axis_colour, subfig_title{what_idx, plot_idx});
                fig_name = [focus_type{focus_idx} '_Übersicht_' ...
                    calc_type{calc_idx} '_' ...
                    err_type{err_idx} '_' what_analysis{what_idx} '_' ...
                    aim_name '.' format];
                ...
                fig = plot_uebersicht({ind_data}, {avg_data}, {err_data}, ...
                    ...
                    mrksz, capsize, jitterwidth, focus_type{focus_idx}, ...
                    0.3, 4, {lin_reg}, true, false, axis_colour, ...
                    subfig_title{what_idx, plot_idx});
                fig_name = [focus_type{focus_idx} '_Übersicht_' ...
                    calc_type{calc_idx} '_' ...
                    err_type{err_idx} '_' what_analysis{what_idx} ...
                    '_' aim_name '.' format];
    ...
    for who_idx = 1:length(who_analysis) - 1
        ...
        for exp_idx = 1:length(curr_experiments)
            ...
            fig = plot_uebersicht_detail(ind_data, avg_data, err_data, ...
                ...
                mrksz, capsize, jitterwidth, 0.3, 4, false, axis_colour, ...
                subfig_title{what_idx, plot_idx});
        ...
        for ver_idx = 1:length(exp_x_vals)
            ...
            for sample_idx = 1:size(numerosities, 1)
                ...
                fig_diff = ...
                    ...
                    exp_x_vals{ver_idx}, axis_colour, true);
                ...
                fig_diff_walsh = ...
                    ...
                    linewidth, mrksz, ...
                    capsize, jitterwidth, 0.3, 4, patterns, ...
                    exp_x_vals{ver_idx}, axis_colour, false);
                % Set Figure File Names
