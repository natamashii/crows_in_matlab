function fig_pretty = ...
    ...
    experiment, plot_font, colours_pattern, plot_pos, linewidth, ...
...
switch focus_type
    case 'Single'
        ...
        for sample_idx = 1:size(numerosities, 1)
            ...
            ax = ...
                ...
                colours_pattern, patterns, mrksz, what_analysis, ...
                focus_type, sample_idx, linewidth);
            ...
            [ax, dot_plots, leg_patch, leg_label] = ...
                ...
                patterns, colours_pattern, plot_font, what_analysis, err_type, linewidth, ...
    ...
    case 'Overall'
        ...
        ax = ...
            plot_ind(numerosities, ind_data, jitter_dots, ...
            colours_pattern, patterns, mrksz, what_analysis, focus_type, 0, linewidth);
