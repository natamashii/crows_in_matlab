...
% Iterate over Amount of Different Subjects
for sub_idx = 1:length(diff_data)
    ...
    for sample_idx = 1:size(numerosities, 1)
        ...
        for exp_idx = 1:length(curr_experiments)
            ...
            diffs_P2P1 = diff_data{sub_idx}{exp_idx, sample_idx}{2, 1};
            diffs_P3P1 = diff_data{sub_idx}{exp_idx, sample_idx}{2, 2};
            diffs_P3P2 = diff_data{sub_idx}{exp_idx, sample_idx}{2, 3};
            ...
            walsh_HL{sub_idx}{exp_idx, sample_idx} = placeholder;
