function [p_value] = psth_grp( filename, grp, cluster, startcode, offset, duration, psth_smoothing, varargin )
%PSTH_DOTRASTER_GRP creates a psth grouped by GRP.
...
% handle_analysis_shade=patch([window(1) window(2) window(2) window(1)], [y(1) y(1) y(2) y(2)], [0.95 0.95 0.95],'EdgeColor','none');
