function [p_value] = norm_psth_grp( filename, grp, cluster, startcode, offset, duration, psth_smoothing, varargin )
...
%
%   NORMALIZATION: Window for normalization is specified below
%       Data is normalized: (FR-mean(baseline))/std(baseline)
%
